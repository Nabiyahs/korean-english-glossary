...
import { DatabaseLimitsMonitor } from "./database-limits-monitor"
              ...
              <>
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-blue-100 border border-blue-300 rounded p-2">
                    ...
                    {debugData.allTerms.length >= 1000 && <p className="text-red-600 mt-1 font-bold">⚠️ 한계 근접!</p>}
                  </div>
                </div>
